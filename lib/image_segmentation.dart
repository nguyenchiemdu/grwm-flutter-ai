...
Future imageSegmentation(File file) async {
  // String url =
  //     'https://img.freepik.com/premium-photo/man-with-sunglasses-taking-selfie_23-2148666530.jpg';
  // final File file = await createFileFromUrl(url);
  ...
  // var customPaint = CustomPaint(painter: painter);
